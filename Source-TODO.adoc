...
** link:./Gomer.Cli/Commands/ImportCsvCommand.cs#L124[124] Move default priority and default hours into constants, or read them from the attributes on the PileGame class.
